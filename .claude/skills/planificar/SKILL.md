---
name: planificar
description: Convierte una spec o diseño mayor en una épica de historias ordenadas por dependencias, con dos puertas de ratificación (diseño y épica). Un nivel por encima de /historia; úsalo cuando el trabajo no cabe en una sola historia (p. ej. una decisión de decisiones/).
...
1. **Reúne la fuente de la spec**: la decisión de `decisiones/`, el doc indicado, o la descripción
...
2. **Fase A — Diseño**: lanza el agente **planificador** (tipo `planificador`) con la fuente.
   ...
   escribe la adenda en `ARCHITECTURE.md` y anota `decisiones/`. Si el diseño ya estaba
...
- El planificador no relitiga decisiones zanjadas (§10/§12) ni cierra abiertas de `decisiones/`
