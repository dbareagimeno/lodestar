...
fn operacion_item_schema() -> Value {
    json!({ "type": "object", "properties": {
                     ...
                     "patch": { "type": "object", "description": "[patch_frontmatter] Merge-patch RFC 7386 recursivo sobre el frontmatter: los objetos se fusionan a cualquier profundidad (si el target no es objeto se empieza desde un objeto vacío), un «null» borra la clave nombrada, las claves ausentes sobreviven y los arrays se sustituyen atómicamente. El patch es quirúrgico cuando puede serlo y conserva el cuerpo; puede reserializar el bloque al fusionar una estructura anidada. Sobre un frontmatter ilegible la operación falla en vez de reescribirlo encima." },
